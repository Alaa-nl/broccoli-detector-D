...
async def detect_broccoli(
    ...
    Steps:
      ...
      3. Convert each box to a crown diameter in mm.
      4. Draw the boxes on a new annotated image.
      5. Return a JSON response with all the results.
    """
    ...
    raw_detections, inference_time_ms = detector.predict(pil_image)

    # --- Step 3: convert each box into a CrownDetection ---
